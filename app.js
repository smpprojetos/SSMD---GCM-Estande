...
function addArchitecture() {
  ...
  // Preserve the repositioned emblem, graffiti and simulator images in model 02.
...
new GLTFLoader().load('./assets/estande-v2.glb',async (gltf)=>{
 try {
  ...
  for(const index of [1010,1012,1014,1016,104,210,266,305,359,415,743,631,639,647,655]) {
