# Estande GCM Ribeirão Pires — Modelo 02A
...
assets/ contém o novo modelo estande-v2a.glb e os logos.
...
Modelo substituído pelo arquivo SMP-GCM-ESTANDE 3D-02A.glb, preservando suas imagens e geometria. Referências das baias atualizadas para a nova exportação. Mantidos o comando da porta, os acabamentos, a iluminação e a navegação.

Extraia em uma pasta nova para evitar misturar versões. No GitHub, substitua os arquivos do visualizador e envie assets/estande-v2a.glb, mantendo as pastas assets e vendor. Após atualizar, use Ctrl+F5 no navegador.
